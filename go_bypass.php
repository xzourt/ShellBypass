...
<title>'.__('Xzourt File manager').'</title>
</head>
<body>
...
<table class="whole">
<form method="post" action="">
<tr><th colspan="2">'.__('Xzourt File manager').' - '.__('Settings').'</th></tr>
...
<table class="whole">
<tr>
    <th><?=__('Xzourt File manager').' - '.$path?></th>
</tr>
<tr>
...
<tr>
    <th><?=__('Xzourt File manager').' - '.__('Edit').' - '.$path.$_REQUEST['edit']?></th>
</tr>
<tr>
    <td class="row1">
        <?=$msg?>
...
<tr>
    <th colspan="2"><?=__('Xzourt File manager')?><?=(!empty($path)?' - '.$path:'')?></th>
</tr>
<?php if(!empty($msg)){ ?>
<tr>
...
<div class="row3"><?php
	...
	echo fm_home().' | ver. '.$fm_version.' | <a href="https://github.com/xzourt">Github</a> | <a href="https://t.me/xzourt">Telegram</a> | <a href="'.fm_site_url().'">.</a>';
